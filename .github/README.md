...
- [`workflows/ci.yml`](workflows/ci.yml) runs the 11 gating lanes, including validated Wasm artifacts and real three-engine bundle smoke jobs, on `main` pushes, pull requests, and manual dispatch.
