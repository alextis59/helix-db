...
This root contains the unpublished Rust workspace. The exact nine boundary crates, dependency direction, maturity markers, and forbidden edges are defined in the [workspace boundary document](../docs/architecture/workspace-boundaries.md).
