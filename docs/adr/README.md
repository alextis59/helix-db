...
| [0012](0012-use-bounded-little-endian-hdoc-v1.md) | Use a bounded little-endian HDoc v1 envelope with separate integrity and content hashes | Accepted | Storage architecture owner | `P03-002`–`P03-013`, `G03` |
