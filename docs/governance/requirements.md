...
| `INV-004` | Deterministic logic stays in the Wasm core; ambient resources are host capabilities. | `P02-001`, `P04-*`, `P13-013`, `P13-021`–`P13-024` | [Core/host workspace boundary](../../evidence/phase-02/P02-001/README.md), host conformance, capability-denial, deterministic replay, ABI benchmarks, `G04`, `G13` | In progress |
...
| `CORE-001` | The Wasm core owns deterministic codecs, semantics, MVCC, planning, metadata, and command application. | `P02-001`, `P03-*`, `P04-001`–`P04-009`, `P06-*`, `P07-*`, `P17-004` | [Initial crate dependency audit](../../evidence/phase-02/P02-001/README.md), deterministic replay, cross-host conformance, `G04`, `G07`, `G17` | In progress |
