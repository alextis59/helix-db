...
| `INV-007` | Persistent formats, commands, semantics, and protocols are versioned. | `P01-018`–`P01-020`, `P02-002`, `P03-001`–`P03-007`, `P15-013`–`P15-017`, `P17-002`, `P24-002` | [Exact toolchain/MSRV/target version evidence](../../evidence/phase-02/P02-002/README.md), golden versions, unknown-version rejection, migrations, rolling upgrades, `G15`, `G24` | In progress |
...
| Requirement | Summary | Implementation tasks | Planned tests and evidence | Status |
| --- | --- | --- | --- | --- |
| `PLAT-001` | Browser hosts feature-detect WebGPU and storage capabilities. | `P02-002`, `P04-012`–`P04-013`, `P10-005`, `P11-005`–`P11-010` | [Pinned browser Wasm compilation target](../../evidence/phase-02/P02-002/README.md), browser capability profiles, host matrix, fallback tests, `G11` | In progress |
| `PLAT-002` | Browser mode works without WebGPU and falls back from OPFS to IndexedDB. | `P02-002`, `P11-005`–`P11-010`, `P11-013`–`P11-018`, `P24-003`–`P24-004` | [GPU-independent portable target check](../../evidence/phase-02/P02-002/README.md), OPFS/IndexedDB conformance, GPU-disabled browser proof, lifecycle/quota reports, `G11` | In progress |
...
| `CORE-003` | Host optimization cannot change persistent or query semantics. | `P01-003`–`P01-004`, `P01-006`, `P02-001`, `P04-006`–`P04-017`, `P11-013`, `P12-012`, `P24-003` | Phase 1 frozen semantics; [workspace forbidden-edge audit](../../evidence/phase-02/P02-001/README.md); copy/handle equivalence, native/browser/server conformance, shared result hashes, `G04`, `G11`, `G12` | In progress |
