...
| `INV-003` | GPU is never required for correctness, durability, recovery, or availability. | `P02-001`, `P10-016`, `P10-017`, `P10-026`, `P11-010`, `P16-005`, `P24-004` | [Optional GPU workspace edge](../../evidence/phase-02/P02-001/README.md), GPU-disabled workflows, unsupported-device matrix, device-loss histories, `G10`, `G16` | In progress |
| `INV-004` | Deterministic logic stays in the Wasm core; ambient resources are host capabilities. | `P02-001`–`P02-002`, `P04-*`, `P13-013`, `P13-021`–`P13-024` | [Core/host workspace boundary](../../evidence/phase-02/P02-001/README.md), [portable Wasm target policy](../../evidence/phase-02/P02-002/README.md), host conformance, capability-denial, deterministic replay, ABI benchmarks, `G04`, `G13` | In progress |
...
| `INV-007` | Persistent formats, commands, semantics, and protocols are versioned. | `P01-018`–`P01-020`, `P02-002`–`P02-004`, `P03-001`–`P03-007`, `P15-013`–`P15-017`, `P17-002`, `P24-002` | [Exact Rust toolchain/MSRV/target version evidence](../../evidence/phase-02/P02-002/README.md), [exact Node/package-manager/tool and lock evidence](../../evidence/phase-02/P02-003/README.md), [versioned source/evidence artifact boundaries](../../evidence/phase-02/P02-004/README.md), golden versions, unknown-version rejection, migrations, rolling upgrades, `G15`, `G24` | In progress |
...
| Requirement | Summary | Implementation tasks | Planned tests and evidence | Status |
| --- | --- | --- | --- | --- |
| `PLAT-001` | Browser hosts feature-detect WebGPU and storage capabilities. | `P02-002`–`P02-003`, `P04-012`–`P04-013`, `P10-005`, `P11-005`–`P11-010` | [Pinned browser Wasm compilation target](../../evidence/phase-02/P02-002/README.md), [pinned three-engine browser harness](../../evidence/phase-02/P02-003/README.md), browser capability profiles, host matrix, fallback tests, `G11` | In progress |
| `PLAT-002` | Browser mode works without WebGPU and falls back from OPFS to IndexedDB. | `P02-002`–`P02-003`, `P11-005`–`P11-010`, `P11-013`–`P11-018`, `P24-003`–`P24-004` | [GPU-independent portable target check](../../evidence/phase-02/P02-002/README.md), [browser-harness policy without GPU assumptions](../../evidence/phase-02/P02-003/README.md), OPFS/IndexedDB conformance, GPU-disabled browser proof, lifecycle/quota reports, `G11` | In progress |
| `PLAT-003` | Native hosts expose wgpu or Dawn behind the common abstraction. | `P02-002`, `P10-001`–`P10-005`, `P10-024`–`P10-025` | [Native/Wasm toolchain boundary](../../evidence/phase-02/P02-002/README.md), GPU ADR, native capability profile, native/browser differential and benchmark reports, `G10` | In progress |
| `CORE-001` | The Wasm core owns deterministic codecs, semantics, MVCC, planning, metadata, and command application. | `P02-001`–`P02-002`, `P03-*`, `P04-001`–`P04-009`, `P06-*`, `P07-*`, `P17-004` | [Initial crate dependency audit](../../evidence/phase-02/P02-001/README.md), [pinned portable target checks](../../evidence/phase-02/P02-002/README.md), deterministic replay, cross-host conformance, `G04`, `G07`, `G17` | In progress |
...
| `CORE-003` | Host optimization cannot change persistent or query semantics. | `P01-003`–`P01-004`, `P01-006`, `P02-001`, `P02-003`–`P02-004`, `P04-006`–`P04-017`, `P11-013`, `P12-012`, `P24-003` | Phase 1 frozen semantics; [workspace forbidden-edge audit](../../evidence/phase-02/P02-001/README.md); [shared TypeScript compiler and test-runner policy](../../evidence/phase-02/P02-003/README.md); [single-corpus conformance/test boundaries](../../evidence/phase-02/P02-004/README.md); copy/handle equivalence, native/browser/server conformance, shared result hashes, `G04`, `G11`, `G12` | In progress |
...
| `QUAL-001` | CPU/GPU equivalence, crash recovery, index consistency, and backup/restore block release. | `P02-004`, `P16-003`–`P16-015`, `P24-003`–`P24-009` | [Cross-component test and release-evidence boundaries](../../evidence/phase-02/P02-004/README.md), full release reports and independent gate review, `G16`, `G24` | Planned |
