...
| `INV-002` | CPU defines reference semantics; GPU returns exact results or verified candidates. | `P01-010`, `P01-017`, `P01-018`, `P07-*`, `P09-*`, `P10-*`, `P24-003`–`P24-004` | Semantic corpus, CPU/column differential, CPU/GPU replay corpus, `G07`, `G09`, `G10` | In progress |
...
| `INV-007` | Persistent formats, commands, semantics, and protocols are versioned. | `P01-018`, `P03-001`–`P03-007`, `P15-013`–`P15-017`, `P17-002`, `P24-002` | Golden versions, unknown-version rejection, migrations, rolling upgrades, `G15`, `G24` | In progress |
...
| Requirement | Summary | Implementation tasks | Planned tests and evidence | Status |
| --- | --- | --- | --- | --- |
| `DATA-001` | Every document has `_id` and a canonical typed HDoc representation. | `P01-001`–`P01-011`, `P01-018`, `P03-*`, `P05-013`, `P08-002` | Semantic fixtures, golden HDoc vectors, ID collision tests, `G01`, `G03`, `G08` | In progress |
...
| `QUERY-002` | Unsupported behavior fails explicitly and is never silently reinterpreted. | `P01-011`, `P01-016`, `P01-018`, `P07-002`, `P07-018`, `P12-009`, `P22-006`, `P22-012`, `P24-012` | Unsupported matrix, typed-error fixtures, adapter protocol tests, claim audit | In progress |
