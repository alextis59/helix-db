...
| `INV-003` | GPU is never required for correctness, durability, recovery, or availability. | `P02-001`, `P02-005`, `P10-016`, `P10-017`, `P10-026`, `P11-010`, `P16-005`, `P24-004` | [Optional GPU workspace edge](../../evidence/phase-02/P02-001/README.md), [GPU-independent native/Wasm/browser profile proof](../../evidence/phase-02/P02-005/README.md), GPU-disabled workflows, unsupported-device matrix, device-loss histories, `G10`, `G16` | In progress |
| `INV-004` | Deterministic logic stays in the Wasm core; ambient resources are host capabilities. | `P02-001`–`P02-002`, `P02-005`, `P04-*`, `P13-013`, `P13-021`–`P13-024` | [Core/host workspace boundary](../../evidence/phase-02/P02-001/README.md), [portable Wasm target policy](../../evidence/phase-02/P02-002/README.md), [separate portable/native build profiles](../../evidence/phase-02/P02-005/README.md), host conformance, capability-denial, deterministic replay, ABI benchmarks, `G04`, `G13` | In progress |
...
| `INV-006` | Clients cannot submit arbitrary WGSL; kernels are internal, bounded, and versioned. | `P02-004`, `P10-004`, `P10-006`, `P10-015`, `P13-015`, `P24-010` | [Internal shader source/trust boundary](../../evidence/phase-02/P02-004/README.md), shader registry/provenance, protocol rejection, resource tests, security review, `G10`, `G13` | Planned |
| `INV-007` | Persistent formats, commands, semantics, and protocols are versioned. | `P01-018`–`P01-020`, `P02-002`–`P02-005`, `P03-001`–`P03-007`, `P15-013`–`P15-017`, `P17-002`, `P24-002` | [Exact Rust toolchain/MSRV/target version evidence](../../evidence/phase-02/P02-002/README.md), [exact Node/package-manager/tool and lock evidence](../../evidence/phase-02/P02-003/README.md), [versioned source/evidence artifact boundaries](../../evidence/phase-02/P02-004/README.md), [exact build/instrumentation contracts](../../evidence/phase-02/P02-005/README.md), golden versions, unknown-version rejection, migrations, rolling upgrades, `G15`, `G24` | In progress |
...
| `CORE-001` | The Wasm core owns deterministic codecs, semantics, MVCC, planning, metadata, and command application. | `P02-001`–`P02-002`, `P02-005`, `P03-*`, `P04-001`–`P04-009`, `P06-*`, `P07-*`, `P17-004` | [Initial crate dependency audit](../../evidence/phase-02/P02-001/README.md), [pinned portable target checks](../../evidence/phase-02/P02-002/README.md), [portable-core profile builds](../../evidence/phase-02/P02-005/README.md), deterministic replay, cross-host conformance, `G04`, `G07`, `G17` | In progress |
...
| Requirement | Summary | Implementation tasks | Planned tests and evidence | Status |
| --- | --- | --- | --- | --- |
| `SEC-001` | External and node operations are authenticated, authorized, encrypted, and auditable. | `P01-016`, `P01-019`, `P13-001`–`P13-008`, `P13-017`–`P13-020`, `P17-014`, `P23-010`, `P24-010` | Authn/authz/mTLS/audit corpus, independent review, cluster security proof, `G13`, `G23` | In progress |
| `SEC-002` | Tenant data and resources respect isolation and quotas across storage, GPU, telemetry, and administration. | `P01-011`, `P01-019`–`P01-020`, `P10-018`, `P13-007`–`P13-017`, `P23-001`–`P23-003`, `P23-016`–`P23-018` | Cross-tenant denial/leak/fairness tests, GPU hygiene, noisy-neighbor report, independent review | In progress |
...
| `QUAL-001` | CPU/GPU equivalence, crash recovery, index consistency, and backup/restore block release. | `P02-004`–`P02-005`, `P16-003`–`P16-015`, `P24-003`–`P24-009` | [Cross-component test and release-evidence boundaries](../../evidence/phase-02/P02-004/README.md), [sanitizer/coverage/benchmark profile foundations](../../evidence/phase-02/P02-005/README.md), full release reports and independent gate review, `G16`, `G24` | Planned |
