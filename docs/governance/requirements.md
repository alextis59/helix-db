...
| `INV-007` | Persistent formats, commands, semantics, and protocols are versioned. | `P01-018`–`P01-020`, `P02-002`–`P02-003`, `P03-001`–`P03-007`, `P15-013`–`P15-017`, `P17-002`, `P24-002` | [Exact Rust toolchain/MSRV/target version evidence](../../evidence/phase-02/P02-002/README.md), [exact Node/package-manager/tool and lock evidence](../../evidence/phase-02/P02-003/README.md), golden versions, unknown-version rejection, migrations, rolling upgrades, `G15`, `G24` | In progress |
...
| `CORE-003` | Host optimization cannot change persistent or query semantics. | `P01-003`–`P01-004`, `P01-006`, `P02-001`, `P02-003`, `P04-006`–`P04-017`, `P11-013`, `P12-012`, `P24-003` | Phase 1 frozen semantics; [workspace forbidden-edge audit](../../evidence/phase-02/P02-001/README.md); [shared TypeScript compiler and test-runner policy](../../evidence/phase-02/P02-003/README.md); copy/handle equivalence, native/browser/server conformance, shared result hashes, `G04`, `G11`, `G12` | In progress |
