...
| [HDoc v1 physical baseline](../adr/0012-use-bounded-little-endian-hdoc-v1.md): checksum, compression, endianness, alignment, offsets, canonical hash, path dictionary, and extensions | Storage architecture owner | Query semantics, runtime, security | ADR 0012 accepted; exact layouts through `P03-007`; codec, values, lookup, conversion, dictionary format/lifecycle, and closed-world feature/migration negotiation implemented at `P03-008`–`P03-015`; immutable fixtures remain | `P03-001`–`P03-015` |
