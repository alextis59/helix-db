...
| [HDoc v1 physical baseline](../adr/0012-use-bounded-little-endian-hdoc-v1.md): checksum, compression, endianness, alignment, offsets, canonical hash, path dictionary, and extensions | Storage architecture owner | Query semantics, runtime, security | ADR 0012 accepted; layouts through `P03-007`; codec, values, lookup, conversion, dictionary format/lifecycle, closed-world negotiation, immutable HDoc 1.0 fixtures, and Rust/TypeScript reader parity implemented at `P03-008`–`P03-017`; property/fuzz hardening remains | `P03-001`–`P03-017` |
