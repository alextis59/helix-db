...
| [Server runtime and WIT component boundary](../adr/0013-use-versioned-wit-component-abi.md) | Runtime architecture owner | Storage, GPU, security | Exact-versioned interface accepted at P04-001; bindings, concrete capabilities, hosts, and conformance required before `G04` | `P04-001`–`P04-017` |
| [HDoc v1 physical baseline](../adr/0012-use-bounded-little-endian-hdoc-v1.md): checksum, compression, endianness, alignment, offsets, canonical hash, path dictionary, and extensions | Storage architecture owner | Query semantics, runtime, security | ADR 0012 accepted; implementation and evidence complete through `P03-021`; P03-021 selects self-contained HDoc 1.0 base/canonical compression and derived-only dictionary IDs; independent `G03` format/security review passed | `P03-001`–`P03-021` |
