...
| [HDoc v1 physical baseline](../adr/0012-use-bounded-little-endian-hdoc-v1.md): checksum, compression, endianness, alignment, offsets, canonical hash, path dictionary, and extensions | Storage architecture owner | Query semantics, runtime, security | ADR 0012 accepted; implementation and evidence complete through `P03-020`; P03-021 selects self-contained HDoc 1.0 base/canonical compression and derived-only dictionary IDs; independent `G03` gate review remains | `P03-001`–`P03-021` |
