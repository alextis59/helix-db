...
implemented [`helix.hdoc-tagged-json/1`](hdoc-v1-tagged-json.md) profile. P03-020 retains formal
direct-field and dotted-path measurements across five representative shapes. P03-021 accepts this
self-contained HDoc 1.0 layout without creating a timing SLO or a dictionary-reference row profile.
