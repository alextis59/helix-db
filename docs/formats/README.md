...
HDoc's byte grammar, Rust writer/reader/value/lookup path, and lossless tagged conversion are
implemented. Dictionary profiles, immutable golden documents, independent readers, fuzzing, and
migrations remain subsequent `P03-*` work. No WAL, MANIFEST, SST, VLOG, CSEG, IDX, backup, or public
