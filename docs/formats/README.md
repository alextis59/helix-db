...
| --- | --- | --- | --- | --- |
| [HDoc envelope](hdoc-v1.md) | 1.0 outer envelope | Writer, validating reader, views, lookup, tagged conversion, negotiation, [immutable fixtures](../../fixtures/hdoc/v1/README.md), Rust/TypeScript parity, and deterministic property/mutation hardening implemented | [Envelope registry](hdoc-v1-envelope.json) | `P03-002`–`P03-018` |
