...
- Plan items: `P02-004`; examples activated by `P02-016`; WIT authority revised through `P04-006`
- Governing gate: `G02`
...
| [`wit/`](../../wit/README.md) | Versioned WebAssembly Interface Type packages | `helix-core-abi-v1/` through `helix-core-abi-v5/` | Immutable ABI 1.0–4.0 plus current explicit-copy ABI 5.0 and reference model; bindings and hosts absent |
