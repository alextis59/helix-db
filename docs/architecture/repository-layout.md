...
| [`wit/`](../../wit/README.md) | Versioned WebAssembly Interface Type packages | `helix-core-abi-v1/`, `helix-core-abi-v2/` | Immutable ABI 1.0 plus current capability ABI 2.0; bindings and host operations absent |
