...
`deterministic-core-boundary-v1` /
...
`deterministic-core-boundary-v1` composition and WIT definition and still reports
...
| `helix-core` | Portable deterministic orchestration and versioned capability ABI | `helix-columnar`, `helix-doc`, `helix-query`, `helix-storage` | Deterministic source/dependency/import gate active; bindings/operations absent |
