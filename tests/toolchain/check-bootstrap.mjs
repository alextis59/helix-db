...
process.stdout.write(
  `PASS clean bootstrap contract: ${contract.profiles.length} profiles, ${supportedPlatforms.length} native hosts, ${contract.troubleshooting.length} troubleshooting codes, immutable HDoc golden vectors active\n`,
);
