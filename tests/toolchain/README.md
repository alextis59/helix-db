...
- `check-retained-artifacts.mjs` checks the policy or one complete generated bundle; `test-artifact-retention-contract.mjs` rejects service, profile, producer, reservation, engine, manifest, payload, and browser-report drift.
