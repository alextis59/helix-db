...
const validatePolicy = () => {
  ...
  assert(
    policy.active_product_scope.allowed_status === 'hdoc-feature-negotiation' &&
...
if (mode === 'policy') {
  process.stdout.write(
    'PASS Rust coverage policy: 3 threshold groups, explicit test-code exclusions, compiler-matched LLVM tools, and active HDoc feature negotiation scope\n',
  );
  process.exit(0);
}
