...
- [x] **P02-001** Create the Rust workspace and initial crate boundaries consistent with the study's proposed dependency direction.
- [x] **P02-002** Select and pin the Rust toolchain, minimum supported version, Wasm targets, formatter, linter, and documentation tools.
...
- [x] **G02** Close the toolchain gate after a clean checkout builds and tests native and browser skeletons using only documented commands.
...
- [x] **P03-005** Define field-table entries, name storage, nested object/array tables, value offsets, and length encodings.
...
- [x] **P04-017** Complete `EXP-003`, select the initial transport, and record thresholds for revisiting it.
